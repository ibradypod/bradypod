...
public:
    ...
    QDateTime lastNetworkAccessTime();
    void setWaitAfterWindowOnloadTime(int msec);
...
private:
    ...
    bool m_status;
    int m_waitAfterWindowOnloadTime;
    QDateTime m_finished_time;
    QTimer *m_timer;

    friend class Bradypod;
